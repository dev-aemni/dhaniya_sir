...
export const slashCommands = [
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand(s => s.setName('setup').setDescription('Open custom welcome embed builder')
      ...
      .addStringOption(o => o.setName('message').setDescription('Fallback message. Use {user} {server} {membercount}')))
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand(s => s.setName('setup').setDescription('Open custom ticket panel embed builder')
